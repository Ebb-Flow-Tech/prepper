      ...
      <Card className="w-full max-w-sm">
        ...
        <CardContent>
          {step === 'email' ? (
             ...
             * and there is no button here to ask for the other kind of sign-in.
             */
            <>
              ...
              {/*
                Google sits on step 2 only. On step 1 it would be a front-door choice offered
                before the server has routed the address — the toggle the email-first design
                exists to remove (spec D7, a deliberate deviation from geddit-one, which renders
                it on both steps).
              */}
