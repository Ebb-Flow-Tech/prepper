...
## CRITICAL
- Do NOT run the generate database migration
- Do NOT run any unit tests yet
- ONLY create the migrations when ALL of the database tables mentioned are created